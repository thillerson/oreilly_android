...
public class TaskManagerApplication extends Application {
	...
	private void loadTasks() {
		...
		Cursor tasksCursor = database.query(TASKS_TABLE, new String[] {TASK_ID, TASK_NAME, TASK_COMPLETE}, null, null, null, null, String.format("%s,%s", TASK_COMPLETE, TASK_NAME));
